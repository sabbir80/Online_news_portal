...
<div style="margin-left: 25%; margin-top: 10%; width: 50%;">
   <div>
    <ul class="breadcrumb">
      ...
      <li class="breadcrumb-item active"><a href="reporter_profile.php">Reporter Profile</a></li>
      <li class="breadcrumb-item active">Change Password</li>
    </ul>
  </div>

<form action="reporter_change_password.php" name="changeform" onsubmit="return validateForm()" method="post">
...
{
alert("Password and Confirm Password Field don't match!");
...
if(isset($_POST['submit'])){
   ...
   $newpass=$_POST['new'];
   $dbpassword=$datapass;
  $query1= mysqli_query($conn,"update reporter set password='$newpass' where
email='$email'");
...
if($password==$dbpassword){
  ...
  if($query){
    ...
    echo "<script>window.location='http://localhost/newsportal/reporter_profile.php'</script>";
  }
}else{
